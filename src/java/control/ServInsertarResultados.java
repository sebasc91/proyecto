 ...
 */
@WebServlet(name = "ServInsertarResultados", urlPatterns = {"/ServInsertarResultados"})
public class ServInsertarResultados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           //se definen variables para conexion
            ...
            insertar.executeUpdate("insert into Resultados (idResultado,NombreResultado)values ("+h.idResultado+",'"+h.NombreResultado+"')");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServInsertarResultados.class.getName()).log(Level.SEVERE, null, ex);
