 ...
 */
@WebServlet(name = "ServLimpiarCompetencias", urlPatterns = {"/ServLimpiarCompetencias"})
public class ServLimpiarCompetencias extends HttpServlet {
