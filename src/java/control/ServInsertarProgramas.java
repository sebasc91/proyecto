 ...
 */
@WebServlet(name = "ServInsertarProgramas", urlPatterns = {"/ServInsertarProgramas"})
public class ServInsertarProgramas extends HttpServlet {
     /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           //se definen variables para conexion
            ...
            h.setNombrePrograma(request.getParameter("NombrePrograma")); 
            ...
            insertar.executeUpdate("insert into Programas (idPrograma,NombrePrograma)values ("+h.getIdPrograma()+",'"+h.getNombrePrograma()+"')");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServInsertarProgramas.class.getName()).log(Level.SEVERE, null, ex);
