 ...
 */
@WebServlet(name = "ServModificarProgramas", urlPatterns = {"/ServModificarProgramas"})
public class ServModificarProgramas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            modificar.executeUpdate("update Programas set NombrePrograma = '"+h.getNombrePrograma()+"' where idPrograma = '"+h.getIdPrograma()+"'");
            rd = request.getRequestDispatcher("/Programas.jsp");
            request.setAttribute("programa", resultado);
