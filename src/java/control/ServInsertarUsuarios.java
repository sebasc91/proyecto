 ...
 */
@WebServlet(name = "ServInsertarUsuarios", urlPatterns = {"/ServInsertarUsuarios"})
public class ServInsertarUsuarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
         ...
         /*
            ...
            insertar.executeUpdate("insert into Usuarios (idUsuario,NombreUsuario,Nombre,Apellidos,Correo,Password)values ("+h.idUsuario+",'"+h.NombreUsuario+"','"+h.Nombre+"','"+h.Apellidos+"','"+h.Correo+"','"+h.Password+"')");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServInsertarUsuarios.class.getName()).log(Level.SEVERE, null, ex);
