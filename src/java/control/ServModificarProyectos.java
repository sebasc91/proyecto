 ...
 */
@WebServlet(name = "ServModificarProyectos", urlPatterns = {"/ServModificarProyectos"})
public class ServModificarProyectos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            modificar.executeUpdate("update Proyecto set NombreProyecto = '"+h.NombreProyecto+"' where idProyecto = '"+h.idProyecto+"'");
