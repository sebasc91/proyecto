 ...
 */
@WebServlet(name = "ServEliminarProgramas", urlPatterns = {"/ServEliminarProgramas"})
public class ServEliminarProgramas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           // h.setIdPerfil(Integer.parseInt(request.getParameter("IdPerfil")));
            ...
            eliminar.executeUpdate("Delete from Programas where (idPrograma="+ h.getIdPrograma()+")");
