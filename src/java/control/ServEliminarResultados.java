 ...
 */
@WebServlet(name = "ServEliminarResultados", urlPatterns = {"/ServEliminarResultados"})
public class ServEliminarResultados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
           ...
           //se definen variables para conexion
            ...
            eliminar.executeUpdate("Delete from Resultados where (idResultado="+ h.getIdResultado()+")");
