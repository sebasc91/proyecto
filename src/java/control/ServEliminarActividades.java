 ...
 */
@WebServlet(name = "ServEliminarActividades", urlPatterns = {"/ServEliminarActividades"})
public class ServEliminarActividades extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           // h.setIdPerfil(Integer.parseInt(request.getParameter("IdPerfil")));
            ...
            eliminar.executeUpdate("Delete from Actividades where (idActividad="+ h.getIdActividad()+")");
