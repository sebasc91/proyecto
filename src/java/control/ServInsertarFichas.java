 ...
 */
@WebServlet(name = "ServInsertarFichas", urlPatterns = {"/ServInsertarFichas"})
public class ServInsertarFichas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           //se definen variables para conexion
            ...
            h.setIdFicha(Integer.parseInt(request.getParameter("idFicha")));
            h.setNombreFicha(request.getParameter("NombreFicha")); 
            ...
            //crear setencia sql  
            String nombre = request.getParameter("NombreFicha");
            insertar.executeUpdate("insert into Ficha (idFicha,NombreFicha)values ("+h.idFicha+",'"+h.NombreFicha+"')");
            rd = request.getRequestDispatcher("/Fichas.jsp");
            request.setAttribute("ficha", null);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServInsertarFichas.class.getName()).log(Level.SEVERE, null, ex);
