 ...
 */
@WebServlet(name = "ServEliminarFases", urlPatterns = {"/ServEliminarFases"})
public class ServEliminarFases extends HttpServlet {
        ...
        PrintWriter out = response.getWriter();
         try {
           ...
           // h.setIdPerfil(Integer.parseInt(request.getParameter("IdPerfil")));
            ...
            eliminar.executeUpdate("Delete from Fases where (idFase="+ h.getIdFase()+")");
