 ...
 */
@WebServlet(name = "ServEliminarAmbientes", urlPatterns = {"/ServEliminarAmbientes"})
public class ServEliminarAmbientes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           // h.setIdPerfil(Integer.parseInt(request.getParameter("IdPerfil")));
            ...
            eliminar.executeUpdate("Delete from Ambiente where (idAmbiente="+ h.getIdAmbiente()+")");
