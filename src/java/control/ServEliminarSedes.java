 ...
 */
@WebServlet(name = "ServEliminarSedes", urlPatterns = {"/ServEliminarSedes"})
public class ServEliminarSedes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           //se definen variables para conexion
            ...
            eliminar.executeUpdate("Delete from Sedes where (idSede="+ h.getIdSede()+")");
