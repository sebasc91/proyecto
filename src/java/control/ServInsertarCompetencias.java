 ...
 */
@WebServlet(name = "ServInsertarCompetencias", urlPatterns = {"/ServInsertarCompetencias"})
public class ServInsertarCompetencias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           //se definen variables para conexion
            ...
            insertar.executeUpdate("insert into Competencia (idCompetencia,NombreCompetencia)values ("+h.idCompetencia+",'"+h.NombreCompetencia+"')");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServInsertarCompetencias.class.getName()).log(Level.SEVERE, null, ex);
