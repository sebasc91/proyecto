 ...
 */
@WebServlet(name = "ServModificarSedes", urlPatterns = {"/ServModificarSedes"})
public class ServModificarSedes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            modificar.executeUpdate("update Sedes set NombreSede = '"+h.NombreSede+"',DireccionSede = '"+h.DireccionSede+"' where idSede = '"+h.idSede+"'");
            rd = request.getRequestDispatcher("/Sedes.jsp");
            request.setAttribute("sede", resultado);
