 ...
 */
@WebServlet(name = "ServEliminarProyectos", urlPatterns = {"/ServEliminarProyectos"})
public class ServEliminarProyectos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           //se definen variables para conexion
            ...
            eliminar.executeUpdate("Delete from Proyecto where (idProyecto="+ h.getIdProyecto()+")");
