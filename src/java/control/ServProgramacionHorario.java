...
import modelo.GuardarPlaneacionHorarios;

/**
 *
 * @author LUIS FERNANDO URREGO
 */
@WebServlet(name = "ServProgramacionHorario", urlPatterns = {"/ServProgramacionHorario"})
public class ServProgramacionHorario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            GuardarPlaneacionHorarios h=new GuardarPlaneacionHorarios();
            ...
            rd = request.getRequestDispatcher("/ProgramacionHorario.jsp");
            request.setAttribute("horario", resultado);
