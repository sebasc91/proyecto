 ...
 */
@WebServlet(name = "ServModificarFicha", urlPatterns = {"/ServModificarFicha"})
public class ServModificarFicha extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            modificar.executeUpdate("update Ficha set NombreFicha = '"+h.NombreFicha+"' where idFicha = '"+h.idFicha+"'");
            rd = request.getRequestDispatcher("/Fichas.jsp");
            request.setAttribute("ficha", resultado);
