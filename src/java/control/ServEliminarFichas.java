 ...
 */
@WebServlet(name = "ServEliminarFichas", urlPatterns = {"/ServEliminarFichas"})
public class ServEliminarFichas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           // h.setIdPerfil(Integer.parseInt(request.getParameter("IdPerfil")));
            ...
            eliminar.executeUpdate("Delete from Ficha where (idFicha="+ h.getIdFicha()+")");
