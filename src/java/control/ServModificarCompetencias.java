 ...
 */
@WebServlet(name = "ServModificarCompetencias", urlPatterns = {"/ServModificarCompetencias"})
public class ServModificarCompetencias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            modificar.executeUpdate("update Competencia set NombreCompetencia = '"+h.NombreCompetencia+"' where idCompetencia = '"+h.idCompetencia+"'");
            rd = request.getRequestDispatcher("/Competencias.jsp");
            request.setAttribute("competencia", resultado);
