 ...
 */
@WebServlet(name = "ServInsertarProyectos", urlPatterns = {"/ServInsertarProyectos"})
public class ServInsertarProyectos extends HttpServlet {
        ...
        PrintWriter out = response.getWriter();
         try {
           ...
           //se definen variables para conexion
            ...
            h.setIdProyecto(Integer.parseInt(request.getParameter("idProyecto")));
            h.setNombreProyecto(request.getParameter("NombreProyecto")); 
            ...
            insertar.executeUpdate("insert into Proyecto (idProyecto,NombreProyecto)values ("+h.idProyecto+",'"+h.NombreProyecto+"')");
            rd = request.getRequestDispatcher("/Proyectos.jsp");
            request.setAttribute("programa", null);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServInsertarProyectos.class.getName()).log(Level.SEVERE, null, ex);
